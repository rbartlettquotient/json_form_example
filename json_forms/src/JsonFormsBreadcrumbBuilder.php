...
/**
 * @file
 * Contains \Drupal\json_forms\JsonFormsBreadcrumbBuilder.
 */
 ...
 */
class JsonFormsBreadcrumbBuilder implements BreadcrumbBuilderInterface {
   ...
   */
    public function __construct(EntityManagerInterface $entity_manager) {
      # $this->storage = $entity_manager->getStorage('json_forms_articles');
    }
...
#    if($route_match->getRouteName() == 'json_forms.admin_get_models') {
#      return TRUE;
#    }
